...
pub enum Commands {
    ...
    Update {
        ...
        /// Automatic silent update (check in background and update if newer, print note only)
...
pub enum ModelCommands {
    ...
    List {
        ...
        /// Show downloadable remote model catalog from Hugging Face
        #[arg(long)]
        remote: bool,
    ...
    Download {
        /// Model type (ixos-flash-v2, ixos-pro-v2, potion, etc.)
        /// If omitted, downloads all supported models.
        model: Option<String>,
